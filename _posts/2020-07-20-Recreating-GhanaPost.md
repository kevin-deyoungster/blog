...
*Screenshot of the frontend for this project (GhanaPostGPS clone). The map on the left shows the location marker and its cell (red polygon). The sidebar on the right shows the address details. **You can access the [demo](https://cutt.ly/ghanapostclone2) here**.*
